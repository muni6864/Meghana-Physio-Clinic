...
function printFinalBill() {
    ...
    // Header
    htmlContent += "<center>";
    htmlContent += "<h1 style='margin:0; color:#1a365d;'>Meghana Physio Care & Home Services</h1>";
    ...
    htmlContent += "<p><i>Issued by: Meghana Physio Care Administration</i></p>";
    htmlContent += "</div>";
    htmlContent += "<div style='text-align:center;'>";
    htmlContent += "<p style='margin-bottom:40px;'><b>Authorized Signatory</b></p>";
    htmlContent += "<p style='font-family:serif; font-size:22px; margin:0;'>Meghana P</p>";
        ...
        function printSessions() {
            ...
            printArea.innerHTML = \`
                <div style="padding:40px; font-family:serif; color:#000;">
                    <center>
                        <h1 style="margin:0; font-size: 28px;">Meghana Physio Care & Home Services</h1>
                    ...
                    <div style="margin-top:80px; text-align:right;">
                        ...
                        <p><strong>Dr. Meghana P</strong></p>
                    </div>
                </div>
            \`;
